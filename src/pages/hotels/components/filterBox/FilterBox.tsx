...
const FilterBox = ({ onChange, rating, adultsAmount, childrenAmount }: FilterBoxProps) => {
  ...
  return (
    <Row>
      ...
      />
      <Counter label="Adults" value={adultsAmount} onChange={(value) => handleChange('adultsAmount', value)} minValue={1}></Counter>
      <Counter label="Children" value={childrenAmount} onChange={(value) => handleChange('childrenAmount', value)}></Counter>
    </Row>
  );
}
